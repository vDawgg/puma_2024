...
train_ds, val_ds, test_ds = get_ds(train_transforms, val_transforms, task="tissue")
...
loss_function = monai.losses.DiceCELoss(include_background=True, sigmoid=True, to_onehot_y=True)
